    				...
    				try {
						...
						if (rs != Statement.EXECUTE_FAILED) {
							...
							if (res_client == Statement.EXECUTE_FAILED)
								throw new SQLException("Nie udało sie wprowadzic klienta!");
							...
							throw new SQLException("Nie udało sie wproawdzic loginu i hasla!");
						
						
						
					} catch (SQLException e1) {
						
						JOptionPane.showMessageDialog(this, e1.getMessage(), "Błąd wprowadzania danych", JOptionPane.ERROR_MESSAGE);
					}
